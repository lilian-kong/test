 ...
 * File description: Implementation of MyLinkedList
 */
...
public class MyLinkedList<E> implements MyReverseList<E>{
    ...
    /**
     * Reverses the region between fromIndex and toIndex (inclusive)
     */
    public void reverseRegion(int fromIndex, int toIndex) throws 
        ...
        Node startNode = getNth(fromIndex);
        Node endNode = getNth(toIndex);
        int halfWayIndex = (toIndex + fromIndex)/2;

        for (int i = fromIndex; i < halfWayIndex; i++) {
